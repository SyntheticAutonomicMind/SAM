...
2. **Choose your provider:**
   - **Cloud AI** - OpenAI, Anthropic (Claude), GitHub Copilot, DeepSeek, Google Gemini, MiniMax, or OpenRouter
...
| **Anthropic** | Claude 4 Sonnet, Claude 4 Opus, Claude 3.5 | Strong reasoning, long context |
