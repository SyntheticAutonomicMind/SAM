...
// MARK: - REMOVED: Anthropic Provider
// Anthropic no longer allows direct API access from third-party harnesses.
// Claude models remain available via GitHub Copilot and OpenRouter.
